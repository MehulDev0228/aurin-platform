...
import { Award, Mail, Lock, User, ArrowRight, Sparkles, CheckCircle } from 'lucide-react';
        ...
        <div className="relative z-10 max-w-xl space-y-12">
          <div>
            ...
            <p className="text-xl text-gray-400 leading-relaxed">
              Get your unique aurin.com/username URL and start showcasing verified credentials.
            </p>
          </div>
          ...
          <div className="space-y-6">
            {[
              ...
              { icon: Sparkles, text: 'Blockchain verification included' },
              { icon: CheckCircle, text: 'Share on LinkedIn, GitHub, resumes' },
            ].map((item, i) => (
          ...
          <div className="premium-card p-8">
            <p className="text-gray-400 mb-4">
              "Aurin helped me land my dream job. Employers loved that they could verify my skills instantly."
            </p>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500">Senior Engineer at Google</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-2 text-xs text-gray-500">
                  Your profile will be: aurin.com/{username || 'yourname'}
                </p>
              </div>
